#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""PRO engine pre VitalityDaily reels (facts dizajn: subjektovo-presny stock, chipy so sync-om, bez mapy) (overeny na Plitvice demu, schvaleny 2026-07-04).
...
UA = {"User-Agent": "VitalityDaily/1.0 (educational channel)"}
...
def render_overlay_seq(sc, idx, work):
    ...
    if role == "hook":
        ...
        chips[0] = {"img": chip_png("@VitalityDaily", 58, "accent"), "at": 0.35}
...
# ---------------------------------------------------------------- render scen
GRADE = "eq=contrast=1.06:saturation=1.15:brightness=0.02,vignette=angle=PI/5.5,noise=alls=3:allf=t"
